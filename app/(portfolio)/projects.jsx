...
},
{
   ...
   imagesAndDescriptions: [
      ...
      { image: require("../../assets/images/SyncR3.png"), description: "This is the Arcade Game Home screen. Still under construction as you can see but it will allow the user to select a character they want and play using them" },
      { image: require("../../assets/images/SyncR4.png"), description: "When \"Music\" is selected in the Home Screen, the user will see this screen with the song lists and a Media Player" },
      { image: require("../../assets/images/SyncR5.png"), description: "If the user clicks the play button a random song starts playing" },
      { image: require("../../assets/images/SyncR6.png"), description: "If they select a song under the \"A Picture of Heaven\" title it'll " },
      { image: require("../../assets/images/SyncR7.png"), description: "If they select a song under the \"A Picture of Heaven\" title it'll " },
      { image: require("../../assets/images/SyncR8.png"), description: "If they select a song under the \"A Picture of Heaven\" title it'll " },
      { image: require("../../assets/images/SyncR9.png"), description: "If they select a song under the \"A Picture of Heaven\" title it'll " },
